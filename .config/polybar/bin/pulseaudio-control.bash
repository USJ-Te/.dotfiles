...
MUTED_COLOR="%{F#fb4934}"  # Color when the audio is muted
...
SINK_NICKNAMES["alsa_output.pci-0000_01_00.1.hdmi-stereo-extra1"]=""
SINK_NICKNAMES["alsa_output.usb-GS3_GS3_20180508-00.iec958-stereo"]=""
SINK_NICKNAMES["bluez_sink.41_42_62_07_CD_9E.a2dp_sink"]=""
...
function getSinkInputs() {
    sinkInputs=$(pacmd list-sink-inputs | grep -B 4 "sink: $1 " | awk '/index:/ {print $2; exit}')
}
...
function output() {
    ...
    if [ "$isMuted" = "yes" ]; then
        ...
        echo "${ICON_COLOR}${volIcon}${END_COLOR}${curVol}% ${SINK_ICON}${nickname} "
    fi
}
