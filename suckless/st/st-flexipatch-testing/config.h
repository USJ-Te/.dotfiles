...
#if FONT2_PATCH
/* Spare fonts */
static char *font2[] = { "JetBrainsMono Nerd Font:style=Regular:pixelsize=15:antialias=true:autohint=true",
						"Weather Icons:style=Regular:pixelsize=16:antialias=true:autohint=true",
